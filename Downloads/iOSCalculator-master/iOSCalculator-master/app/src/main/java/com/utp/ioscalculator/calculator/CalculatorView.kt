        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    ShowButton("AC", Color(0xFFA5A5A5), viewModel)
                    ShowButton("⁺/₋", Color(0xFFA5A5A5), viewModel)
                    ShowButton("%", Color(0xFFA5A5A5), viewModel)
                    ShowButton("÷", Color(0xFFFD9100), viewModel)
                }
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.spacedBy(7.dp)
                    ...
                    ShowButton("x", Color(0xFFFD9100), viewModel)
                }
                Row(
                    modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.spacedBy(7.dp)
